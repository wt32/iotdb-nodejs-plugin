...
class TSSetUsingTemplateReq;

class TSDropSchemaTemplateReq;

class TSOperationSyncWriteReq;
...
class TSGetSystemStatusResp : public virtual ::apache::thrift::TBase {
 public:

  TSGetSystemStatusResp(const TSGetSystemStatusResp&);
  TSGetSystemStatusResp& operator=(const TSGetSystemStatusResp&);
  TSGetSystemStatusResp() : systemStatus() {
  }

  virtual ~TSGetSystemStatusResp() noexcept;
  TSStatus status;
  std::string systemStatus;

  void __set_status(const TSStatus& val);

  void __set_systemStatus(const std::string& val);

  bool operator == (const TSGetSystemStatusResp & rhs) const
  {
    if (!(status == rhs.status))
      return false;
  ...
  bool operator < (const TSGetSystemStatusResp & ) const;
...
void swap(TSGetSystemStatusResp &a, TSGetSystemStatusResp &b);

std::ostream& operator<<(std::ostream& out, const TSGetSystemStatusResp& obj);
...
typedef struct _TSInsertStringRecordReq__isset {
  _TSInsertStringRecordReq__isset() : isAligned(false) {}
  bool isAligned :1;
...
class TSInsertStringRecordReq : public virtual ::apache::thrift::TBase {
 public:
  ...
  TSInsertStringRecordReq() : sessionId(0), prefixPath(), timestamp(0), isAligned(0) {
  }
...
typedef struct _TSCreateAlignedTimeseriesReq__isset {
  _TSCreateAlignedTimeseriesReq__isset() : measurementAlias(false) {}
  bool measurementAlias :1;
...
typedef struct _TSRawDataQueryReq__isset {
  _TSRawDataQueryReq__isset() : fetchSize(false), enableRedirectQuery(false), jdbcQuery(false) {}
  bool fetchSize :1;
  bool enableRedirectQuery :1;
  bool jdbcQuery :1;
...
class TSRawDataQueryReq : public virtual ::apache::thrift::TBase {
 public:
  ...
  TSRawDataQueryReq() : sessionId(0), fetchSize(0), startTime(0), endTime(0), statementId(0), enableRedirectQuery(0), jdbcQuery(0) {
  }
...
typedef struct _TSLastDataQueryReq__isset {
  _TSLastDataQueryReq__isset() : fetchSize(false), enableRedirectQuery(false), jdbcQuery(false) {}
  bool fetchSize :1;
  bool enableRedirectQuery :1;
  bool jdbcQuery :1;
...
class TSLastDataQueryReq : public virtual ::apache::thrift::TBase {
 public:
  ...
  TSLastDataQueryReq() : sessionId(0), fetchSize(0), time(0), statementId(0), enableRedirectQuery(0), jdbcQuery(0) {
  }
...
class TSSetUsingTemplateReq : public virtual ::apache::thrift::TBase {
 public:

  TSSetUsingTemplateReq(const TSSetUsingTemplateReq&);
  TSSetUsingTemplateReq& operator=(const TSSetUsingTemplateReq&);
  TSSetUsingTemplateReq() : sessionId(0), dstPath() {
  }

  virtual ~TSSetUsingTemplateReq() noexcept;
  int64_t sessionId;
  std::string dstPath;
  ...
  bool operator == (const TSSetUsingTemplateReq & rhs) const
  {
    if (!(sessionId == rhs.sessionId))
      return false;
  ...
  bool operator < (const TSSetUsingTemplateReq & ) const;
...
void swap(TSSetUsingTemplateReq &a, TSSetUsingTemplateReq &b);

std::ostream& operator<<(std::ostream& out, const TSSetUsingTemplateReq& obj);
...
class TSOperationSyncWriteReq : public virtual ::apache::thrift::TBase {
 public:

  TSOperationSyncWriteReq(const TSOperationSyncWriteReq&);
  TSOperationSyncWriteReq& operator=(const TSOperationSyncWriteReq&);
  TSOperationSyncWriteReq() : sessionId(0), operationSyncType(0), physicalPlan() {
  }

  virtual ~TSOperationSyncWriteReq() noexcept;
  int64_t sessionId;
  int8_t operationSyncType;
  std::string physicalPlan;

  void __set_sessionId(const int64_t val);

  void __set_operationSyncType(const int8_t val);

  void __set_physicalPlan(const std::string& val);

  bool operator == (const TSOperationSyncWriteReq & rhs) const
  {
    if (!(sessionId == rhs.sessionId))
      return false;
    if (!(operationSyncType == rhs.operationSyncType))
      return false;
    if (!(physicalPlan == rhs.physicalPlan))
      return false;
    return true;
  }
  bool operator != (const TSOperationSyncWriteReq &rhs) const {
  ...
  bool operator < (const TSOperationSyncWriteReq & ) const;
...
void swap(TSOperationSyncWriteReq &a, TSOperationSyncWriteReq &b);

std::ostream& operator<<(std::ostream& out, const TSOperationSyncWriteReq& obj);
